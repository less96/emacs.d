...
You can specify the ignore regex like =!keyword1= in =ivy=. If you want to ignore multiple keywords, you *must* use syntax like =!keyword1\|!keyword2=. But ignore syntax not work correctly in counsel, so I suggest using =counsel-etags-grep= instead.
